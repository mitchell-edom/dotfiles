...
# enable bob
source ~/workspace/vms/vms-bob/bob
...
alias baom=AWS_PROFILE=wpl-ctl-master-cops-permset-platformadmin-sso bob awsurl open


enc_locate () {
    curl --silent --socks5-host "$(bob get-config .internal_ip):1080" "https://compliance.security.prd.woodside/instance?search=$1" | jq
}
